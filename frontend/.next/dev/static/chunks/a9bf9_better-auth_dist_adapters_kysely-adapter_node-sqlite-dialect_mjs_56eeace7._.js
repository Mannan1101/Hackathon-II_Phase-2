...
"[project]/node_modules/better-auth/dist/adapters/kysely-adapter/node-sqlite-dialect.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var NodeSqliteIntrospector = class {
    ...
    async #getTableMetadata(table) {
        ...
        return {
            name: table,
            columns: (await db.selectFrom(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$kysely$2f$dist$2f$esm$2f$raw$2d$builder$2f$sql$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["sql"]`pragma_table_info(${table})`.as("table_info")).select([
                "name",
                "type",
                "notnull",
                "dflt_value"
...
var NodeSqliteQueryCompiler = class extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$kysely$2f$dist$2f$esm$2f$query$2d$compiler$2f$default$2d$query$2d$compiler$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DefaultQueryCompiler"] {
...
//# sourceMappingURL=a9bf9_better-auth_dist_adapters_kysely-adapter_node-sqlite-dialect_mjs_56eeace7._.js.map